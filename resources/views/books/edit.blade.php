                ...
                <div class="card-body">
                    <form action="{{ route('books.update', $book->id) }}" method="post" enctype="multipart/form-data">
                        ...
                        <div class="mb-3">
                            ...
                            <textarea name="description" value="{{ old('description', $book->description) }}" id="description" class="form-control" placeholder="Description" cols="30" rows="5"></textarea>
                        </div>
                        <div class="mb-3">
                            ...
                            @error('image')
                                ...
                                @enderror   
                                @if (!empty($book->image))
                                    <img class="w-25" src=" {{  asset('uploads/books/thumb/'. $book->image) }} " alt="">
